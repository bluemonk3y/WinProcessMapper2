...
sub getSamples(count)
	...
	If PercentProcessorTime < 0 Then
		...
		'WSCript.Echo FormatDateTime(Now(),2) & sep & FormatDateTime(Now(),4) & sep & cName & sep & PercentProcessorTime & sep & PercentUserTime & sep & PercentPrivilegedTime & sep & PercentInterruptTime
